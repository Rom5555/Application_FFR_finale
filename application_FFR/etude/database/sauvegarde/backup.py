...
if __name__ == '__main__':
    ...
    USER = "dev"
    PASSWORD = "ballon"
    SCRIPTS_DIRECTORY = "C:\\Users\\romfa\\Dev\\Application_FFR_V5\\etude\\database\\sauvegarde\\backup_file.dump"
    ...
    command = "pg_dump -U {0} -h {1} -p {2} -Fc {3} > {4}".format(USER, SERVER, PORT, DATABASE, SCRIPTS_DIRECTORY)
    print(command)
    os.system(command)
