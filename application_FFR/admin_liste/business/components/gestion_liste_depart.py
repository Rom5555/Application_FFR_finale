...
from admin_stock.data.data_stock import Data_stock
...
class Gestion_liste_depart(Ifonction_get,Ifonction_create,Ifonction_update):
    ...
    def create_association_liste_depart_produit(self):
        ...
        if int(self.produit.quantite_depart) > 0:
            ...
            print("la quantite_depart du produit est egale à 0")

    def delete_association_liste_depart_produit(self):

        self._data_liste_depart.delete_association_liste_depart_produit(self.liste_depart.id, self.produit.id)
    ...
    def get_liste_vierge(self):
        ...
        for row in rows:
            produit={
                ...
                'quantite_depart': None,
                'quantite_retour': None,
            }
            produits.append(produit)
