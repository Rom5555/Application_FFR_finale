    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_deplacement', models.ForeignKey(blank=True, db_column='id_deplacement', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='admin_base.deplacement')),
                ('id_equipe', models.ForeignKey(blank=True, db_column='id_equipe', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='admin_base.equipe')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_categorie_produit', models.ForeignKey(blank=True, db_column='id_categorie_produit', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='admin_base.categorieproduit')),
            ],
            options={
                'db_table': 'produit',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_produit', models.ForeignKey(blank=True, db_column='id_produit', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='admin_base.produit')),
                ('id_stock', models.ForeignKey(blank=True, db_column='id_stock', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='admin_base.stock')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_liste_depart', models.ForeignKey(blank=True, db_column='id_liste_depart', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='admin_base.listedepart')),
                ('id_utilisateur', models.ForeignKey(blank=True, db_column='id_utilisateur', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='admin_base.utilisateur')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_liste_utilisateur', models.ForeignKey(blank=True, db_column='id_liste_utilisateur', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='admin_base.listeutilisateur')),
                ('id_produit', models.ForeignKey(blank=True, db_column='id_produit', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='admin_base.produit')),
            ],
            options={
